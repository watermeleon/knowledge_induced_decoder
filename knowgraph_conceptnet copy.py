    ...
    def get_vm_from_imgid(self, contextfeat):
        ...
        for image_emb in contextfeat:
            ...
            for ind in topNind:
                ...
                topNemblist.append(self.all_keywordembed[ind])
            emb_batch.append(topNemblist)
            sent_batch.append(topNwordlist)
        return self.add_knowledge_with_vm(sent_batch, emb_batch, image_emb=all_img_embs, max_edges=self.rw_size, add_pad=True, max_length=64, prefix_size = None)


    def add_knowledge_with_vm(self, sent_batch, emb_batch, image_emb=None, max_edges=5, add_pad=True, max_length=128, prefix_size = None):
        """
        ...
        seg_batch = []
        sent_sizes = []
        for sent_it, split_sent in enumerate(sent_batch):
            # create tree
            sent_tree = []
            ...
            for token_it, token in enumerate(sent_batch):    
                ...
                # NOTE: TODO: did till here
                sent_tree.append((emb_batch[sent_it][token_it], entities))
