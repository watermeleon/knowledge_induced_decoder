...
class Transformer(CaptioningModel):
    ...
    def forward(self, images, seq,contextfeat, *args):
        # images: image features, seq: caption
        enc_output, mask_enc = self.encoder(images)
        dec_output = self.decoder(seq, enc_output, mask_enc, contextfeat)
        return dec_output
    ...
    def step(self, t, prev_output, visual, seq, mode='teacher_forcing',contextfeat=False, **kwargs):
        it = None
        # print("mode in step is:", mode)
        ...
        return self.decoder(it, self.enc_output, self.mask_enc, contextfeat)
